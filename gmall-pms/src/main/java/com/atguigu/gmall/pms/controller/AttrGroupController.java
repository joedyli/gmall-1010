...
public class AttrGroupController {
    ...
    public ResponseVo<List<GroupVo>> queryGroupWithAttrsByCid(@PathVariable("catId")Long catId){
        List<GroupVo> groupVos = this.attrGroupService.queryGroupWithAttrsByCid(catId);
